...
{
	Pixel lhs;		///< Variable for left hand side Pixel object
...
{
	out << '[' << RED << (int)rhs.red_ << NORM << ", " << GREEN << (int) rhs.green_ << NORM << ", " << BLUE << (int)rhs.blue_ << NORM << ']' << endl;
